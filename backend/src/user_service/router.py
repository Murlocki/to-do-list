...
from src.user_service.auth_functions import validate_password, get_session_by_token
...
def login_user(auth_form: AuthForm, db: Session = Depends(get_db)) -> dict[str, str | Any]:
